...
export const minikitConfig = {
  ...
  miniapp: {
    ...
    screenshotUrls: ["https://mints.personalids.xyz/screenshot-portrait1.png"],
    iconUrl: "https://mints.personalids.xyz/icon1.png",
    splashImageUrl: "https://mints.personalids.xyz/hero1.png",
    splashBackgroundColor: "#000000",
    ...
    heroImageUrl: "https://mints.personalids.xyz/hero1.png",
    tagline: "Mint your onchain identity",
    ogTitle: "Personal ID Mint",
    ogDescription: "Mint a unique onchain ID on Base with daily check-in Rewards",
    ogImageUrl: "https://mints.personalids.xyz/og1.png",
  },
} as const;